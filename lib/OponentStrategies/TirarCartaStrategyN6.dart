...
class TirarCartaStrategyN6 implements TirarCartaStrategy {
  ...
  List<List<int>> linea32 = [[2, 2, 2, 0, 0], [2, 2, 0, 2, 0], [2, 2, 0, 0, 2], [2, 0, 2, 0, 2], [2, 0, 0, 2, 2],
  ...
  bool VerSiTiroCarta(int numero, Carta carta, int cantLinea) {
    ...
    if (numero == 1) {
      if(cantLinea == 4)opciones = opciones1;
